            ...
            <table>
                <thead>
                    ...
                    <tr>
                        ...
                        <th colspan="2">Dias restantes: </th>
                    </tr>
                ...
                <tbody>
                    ...
                    <?php foreach ($reservaciones as $reservacion) : ?>
                        <tr>
                            ...
                            <td>
                                <?php echo $reservacion->fecha_entrega ?>
                            </td>

                            <td>
                                <?php
                                $fecha          = new DateTime($reservacion->fecha);
                                $fecha_entrega  = new DateTime($reservacion->fecha_entrega);

                                echo $fecha->diff($fecha_entrega)->days . ' dias';
                                ?>
                            </td>
